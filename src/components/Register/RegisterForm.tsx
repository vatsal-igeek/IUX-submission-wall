        ...
        <form className="text-start max-w-[45rem] mx-auto" onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[1.875rem]">
            ...
            <div>
              ...
              <input
                ...
                placeholder="John"
                autoComplete="off"
                className={`w-full p-4 bg-inputBg text-white placeholder:text-subTitle rounded-lg focus:outline-none focus:border ${errors.firstName ? "border-red-500" : "focus:border-primary-main"}`}
              />
            ...
            <div>
              ...
              <input
                ...
                placeholder="Doe"
                autoComplete="off"
                className={`w-full p-4 bg-inputBg text-white placeholder:text-subTitle rounded-lg focus:outline-none focus:border ${errors.lastName ? "border-red-500" : "focus:border-primary-main"}`}
              />
          ...
          <div className="mt-[1.875rem]">
            ...
            <input
              ...
              autoComplete="off"
              className={`w-full p-4 bg-inputBg text-white placeholder:text-subTitle rounded-lg focus:outline-none focus:border ${errors.email ? "border-red-500" : "focus:border-primary-main"}`}
            />
              ...
              <div className="relative" ref={genderDropdown.dropdownRef}>
                <button
                  ...
                  className={`w-full p-4 bg-inputBg text-white rounded-lg focus:outline-none focus:border flex items-center justify-between ${
                    errors.gender ? "border-red-500" : "focus:border-primary-main"
                  }`}
                >
                ...
                {genderDropdown.isOpen && (
                  <div
                    className={`absolute left-0 right-0 bg-inputBg rounded-lg shadow-lg z-50 ${genderDropdown.direction === "up" ? "bottom-full mb-2" : "top-full mt-2"}`}
                    style={{ maxHeight: 300 }}
                  >
          ...
          <div className="mt-[1.875rem]">
            ...
            <div className="relative" ref={countryDropdown.dropdownRef}>
              <button
                ...
                className={`w-full p-4 bg-inputBg text-white rounded-lg focus:outline-none focus:border flex items-center justify-between ${
                  errors.country ? "border-red-500" : "focus:border-primary-main"
                }`}
              >
              ...
              {countryDropdown.isOpen && (
                <div
                  className={`absolute flex flex-col left-0 right-0 bg-inputBg rounded-lg shadow-lg z-50 ${countryDropdown.direction === "up" ? "bottom-full mb-2" : "top-full mt-1"}`}
                  style={{ maxHeight: 300 }}
                >
                  <input
                    type="text"
