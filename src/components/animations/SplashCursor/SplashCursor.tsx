...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function initFramebuffers() {
      ...
      if (!rgba || !rg || !r) {
        throw new Error("Required WebGL formats not supported");
      }
    ...
    function generateColor(): ColorRGB {
            // Use primary main and secondary colors instead of random HSV
      const colors = [
        { r: 0.059, g: 0.937, b: 0.620 }, // #0FEF9E (primary main)
        { r: 0.157, g: 0.686, b: 1.000 }  // #28AFFF (primary secondary)
      ];
      ...
      // Apply lighter intensity scaling for brighter colors
      return {
